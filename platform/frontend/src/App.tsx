    ...
    <AuthProvider>
      <Routes>
          <Route element={<Layout />}>
            ...
            <Route path="/settings/autonomous-testing" element={<ProtectedRoute><Suspense fallback={LazyFallback}><SettingsLayout /></Suspense></ProtectedRoute>} />
            ...
            <Route path="/discussions" element={<ProtectedRoute><Suspense fallback={LazyFallback}><DiscussionsPage /></Suspense></ProtectedRoute>} />
            <Route path="/discussions/:id" element={<ProtectedRoute><Suspense fallback={LazyFallback}><DiscussionDetailPage /></Suspense></ProtectedRoute>} />
            ...
            <Route path="/settings/agent-teams" element={<ProtectedRoute><Suspense fallback={LazyFallback}><SettingsLayout /></Suspense></ProtectedRoute>} />
