...
vi.mock('./CodeMergePage', () => ({
  default: () => <div data-testid="code-merge-page">CodeMergePage</div>,
}))
...
vi.mock('./ViewTransitionPage', () => ({
  default: () => <div data-testid="view-transition-page">ViewTransitionPage</div>,
}))
