...
const TAB_GROUPS: TabGroup[] = [
  ...
  },
  {
    ...
    tabs: ['background-agents', 'agent-framework', 'agent-automation', 'agent-skills', 'agent-builder', 'agent-rules', 'agent-terminal', 'agent-trace', 'agentic-workflows', 'agent-messages', 'parallel-agents', 'agent-sdk', 'auto-terminal', 'confidence-scoring', 'orchestration', 'langgraph', 'agentic-planning', 'agent-inbox', 'dynamic-intelligence', 'visual-workflow'],
  },
  {
    key: 'testing',
