...
const TAB_GROUPS: TabGroup[] = [
  ...
  },
  {
    ...
    tabs: ['background-agents', 'agent-automation', 'agent-skills', 'agent-rules', 'agent-terminal', 'agent-trace', 'agentic-workflows', 'agent-messages', 'parallel-agents', 'agent-sdk', 'auto-terminal', 'confidence-scoring', 'orchestration', 'langgraph', 'agentic-planning', 'agent-inbox', 'dynamic-intelligence', 'visual-workflow'],
  },
  {
    key: 'testing',
