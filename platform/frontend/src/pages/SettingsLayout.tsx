...
const AgentTeamsPage = lazy(() => import('./AgentTeamsPage'))
...
const ReactPerformancePage = lazy(() => import('./ReactPerformancePage'))
const McpServerPage = lazy(() => import('./McpServerPage'))
const AspireDashboardPage = lazy(() => import('./AspireDashboardPage'))
...
const TAB_GROUPS: TabGroup[] = [
  ...
  },
  {
    ...
    tabs: ['preview', 'containerization', 'database-branching', 'sandbox', 'infrastructure', 'platform-upgrade', 'deployment-health', 'production-sandboxes', 'managed-backend', 'aspire-dashboard'],
  },
  {
    key: 'security',
  ...
  },
  {
    ...
    tabs: ['background-agents', 'agent-framework', 'agent-automation', 'agent-skills', 'agent-teams', 'agent-builder', 'agent-rules', 'agent-terminal', 'agent-trace', 'agentic-workflows', 'agent-messages', 'parallel-agents', 'agent-sdk', 'auto-terminal', 'confidence-scoring', 'orchestration', 'langgraph', 'agentic-planning', 'agent-inbox', 'dynamic-intelligence', 'visual-workflow'],
  },
  {
    key: 'testing',
  ...
  },
  {
    ...
    tabs: ['specifications', 'github-sync', 'bidir-sync', 'collaborative-editing', 'version-history', 'performance', 'react-performance', 'observability', 'build-toolchain', 'vision-to-code', 'screenshot-to-code', 'edit-predictions', 'browser-ide', 'dotnet-perf', 'dotnet10-upgrade', 'figma-import', 'visual-overlay', 'planning-mode', 'project-docs', 'api-cli', 'api-docs', 'pipeline-builder', 'view-transitions', 'voice-input', 'mobile-app', 'mcp-server'],
  },
  {
    key: 'integrations',
...
const TAB_LABELS: Record<SettingsTab, [string, string]> = {
  ...
  'agent-framework': ['settings.tabs.agentFramework', 'Agent FW'],
  ...
  'agent-teams': ['settings.tabs.agentTeams', 'Agent Teams'],
  ...
  'react-performance': ['settings.tabs.reactPerformance', 'React 19 Perf'],
  'mcp-server': ['settings.tabs.mcpServer', 'MCP Server'],
  'aspire-dashboard': ['settings.tabs.aspireDashboard', 'Aspire'],
}
...
export default function SettingsLayout() {
  ...
  return (
    <section>
      ...
      {settingsTab === 'agent-framework' && <AgentFrameworkPage />}
      ...
      {settingsTab === 'agent-teams' && <AgentTeamsPage />}
      ...
      {settingsTab === 'react-performance' && <ReactPerformancePage />}
      {settingsTab === 'mcp-server' && <McpServerPage />}
      {settingsTab === 'aspire-dashboard' && <AspireDashboardPage />}
          </Suspense>
        </div>
      </div>
    </section>
